...
public class ContractService {
     ...
     */
    @Transactional
    public ContractAcceptance acceptContract(Long contractId, User user, String guestUserId, HttpServletRequest request) {
     ...
     */
    @Transactional
    public ContractAcceptance rejectContract(Long contractId, User user, String guestUserId, HttpServletRequest request) {
        Contract contract = contractRepository.findById(contractId)
                .orElseThrow(() -> new ResourceNotFoundException("Sözleşme bulunamadı: " + contractId));
