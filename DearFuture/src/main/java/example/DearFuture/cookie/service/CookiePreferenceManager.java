...
@Slf4j
@Validated
public class CookiePreferenceManager implements CookiePreferenceService {
     ...
     */
    private CookiePreference createNewPreference(User user, String sessionId, String ipAddress, String userAgent) {
    ...
    @Override
    @Transactional(readOnly = true)
    public boolean isConsentVersionCurrent(User user, String sessionId, HttpServletRequest httpRequest) {
        Optional<CookiePreference> preferenceOpt = getCookiePreference(user, sessionId, httpRequest);
