package example.DearFuture.cookie.entity;
...
@Table(name = "cookie_preferences", indexes = {
    @Index(name = "idx_cookie_pref_user_id", columnList = "user_id"),
    @Index(name = "idx_cookie_pref_session_id", columnList = "session_id"),
    @Index(name = "idx_cookie_pref_ip_address", columnList = "ip_address"),
    @Index(name = "idx_cookie_pref_consent_date", columnList = "consent_date")
})
@Data
@Builder
@NoArgsConstructor
